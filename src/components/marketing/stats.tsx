                    ...
                    {STATS.map((stat, index) => (
                        ...
                        >
                            <div className="flex flex-col items-center justify-center">
                                <div className="flex items-center justify-center px-4 lg:px-6 py-2 rounded-full relative before:absolute before:inset-0 before:-z-10 before:p-[1.5px] before:rounded-3xl before:bg-gradient-to-b before:from-[#d4af37]/70 before:to-transparent before:content-[''] after:absolute after:inset-[1.5px] after:-z-10 after:rounded-[22px] after:bg-[#141414]/80">
                                    <Image
                                        src={stat.icon}
                                        alt="Stats"
                                        width={1024}
                                ...
                                <div className="text-center">
                                    <h4 className="text-lg lg:text-2xl text-transparent bg-gradient-to-b from-[#f5f0d5] to-[#b8941f] bg-clip-text font-semibold mt-5">
                                        {stat.value}
                                    </h4>
