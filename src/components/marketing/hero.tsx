...
// import { HeroQuotation } from "./hero-quotation";
        ...
        <div className="flex flex-col items-center justify-center w-full z-10">
          ...
          <Container delay={0.2}>
            <p className="text-base md:text-lg font-normal text-center text-balance text-muted-foreground max-w-3xl mx-auto mt-4">
              Envie seus detalhes de viagem, deixe nossos especialistas analisar
              rotas, negociar tarifas com companhias aéreas e retornar com as
              melhores opções para você ou seu time.
            </p>
          </Container>
        </div>
      </Wrapper>
