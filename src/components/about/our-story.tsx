            ...
            <Container delay={0.3} className="mt-auto">
              <div className="flex items-center gap-4">
                <p className="text-base md:text-lg text-muted-foreground text-left mt-2 max-w-2xl">
                  Nossa equipe combina experiência em distribuição aérea,
                  atendimento consultivo e engenharia de software focada em
                  viagens.
                </p>
              </div>
            </Container>
          ...
          <div className="flex flex-col gap-8">
            <Container className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 text-base text-neutral-400">
                  Começamos como consultores de travel management e evoluímos
                  criando soluções para simplificar jornadas de viajantes
                  corporativos.
                </div>
              </div>
            </Container>
            <Container delay={0.1} className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 text-base text-neutral-400">
                  Cada melhoria nasce de sprints conjuntos com empresas
                  atendidas, garantindo aderência total às necessidades de quem
                  viaja.
                </div>
              </div>
            </Container>
            <Container delay={0.2} className="flex items-start gap-6">
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 text-base text-neutral-400">
                  Investimos em especialistas de dados, tarifas e suporte para
                  manter o padrão Exceller em cada nova conta.
                </div>
              </div>
            </Container>
          </div>
